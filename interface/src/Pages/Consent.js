      ...
      >
        ...
        <div className="consent-form text-lg">
          ...
          <p className="text-main mb-4">
            ...
            <u>harsh@cs.toronto.edu</u>) and <strong>Ewan Jordan</strong> (
            <u>ewan.jordan@mail.utoronto.ca</u>). If you have any questions or
        ...
        <button
          onClick={handleClick}
          className="mt-3 text-2xl outline outline-offset-2 outline-2 rounded-md font-semibold px-4 py-1 hover:bg-slate-100"
        >
          SUBMIT
        </button>
      </div>
