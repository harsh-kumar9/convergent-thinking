  ...
  return !(promptId === 6) ? (
    ...
    >
      <div className="flex flex-row space-x-4 p-4 h-full w-full items-center justify-center rounded-[60px]">
        <div
          className="w-1/2 rounded-[60px] bg-orange-500 flex flex-col items-center h-full px-4  outline outline-2 outline-white bg-slate-500"
        ...
        <div
          className="w-1/2 rounded-[60px] bg-orange-500 flex flex-col h-full p-6 outline outline-2 outline-white bg-slate-500"
          style={{ backgroundColor: "rgba(64, 64, 64, 0.17)" }}
        >
