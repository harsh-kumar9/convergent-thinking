...
const Generate = () => {
  ...
  return !(promptId === 6) ? (
    <div
      ...
      className="h-screen w-screen place-items-center justify-center flex text-3xl font-semibold space-y-8 p-8 bg-cover"
    >
      <div className="flex flex-row space-x-4 p-4 w-full h-full place-items-center justify-center rounded-[60px]">
        ...
        >
          ...
          >
            ...
            >
              <h2 className="text-white text-4xl pr-100 p-1">
              ...
              <div className="float-right">
                ...
                <input
                  type="submit"
                  value="SUBMIT"
                  className="text-white bg-slate-400 outline outline-2 rounded-md font-bold text-xl px-2 hover:bg-orange-500"
                />
              </div>
            </div>
          </form>
          ...
          <div
            className="text-white select-none h-full text-xs w-full bg-orange-600 rounded-b-[20px] rounded-lg mt-4 p-2 whitespace-pre-line overflow-auto"
            style={{ backgroundColor: "rgba(71, 85, 105, 0.18)" }}
          >
            blah blah
          </div>
