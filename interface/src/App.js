  ...
  useEffect(() => {  
    ...
    return (
      <div className="App">
        {!acceptedHIT ? (
          <div>
            In this study, you will be asked to complete numerous remote association tasks. 
            ...
            <mTurkContext.Provider value={{mTurk, addMTurk}}>
              <Router>
                <Routes>
                  ...
                  <Route path="/convergent/instructabsent" element={<InstructAbsent />} />
                  <Route path="/convergent/instructgenerate" element={<InstructGenerate />} />
                  <Route path="/convergent/instructcoach" element={<InstructCoach />} />
